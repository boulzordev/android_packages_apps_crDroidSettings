...
package com.crdroid.settings.fargments.statusbar;
...
public class ClockSettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createCustomView() {
        ...
        mClockDateDisplay.setValue(Integer.toString(Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.STATUS_BAR_CLOCK_DATE_DISPLAY,
                0)));
        ...
        boolean mClockDateToggle = Settings.System.getInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_DATE_DISPLAY, 0) != 0;
        if (!mClockDateToggle) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_AM_PM, val);
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_DATE_DISPLAY, val);
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.STATUS_BAR_CLOCK_DATE_STYLE, val);
